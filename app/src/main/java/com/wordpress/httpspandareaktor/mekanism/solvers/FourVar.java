...
public class FourVar extends AppCompatActivity {
    ...
    public void setSymbolsAndUnits(Spanned symA, Spanned symB, Spanned symC, Spanned symD,
        ...
        //setting buffertype.spannable allows TextView to properly calculate the line height
        ...
        symbolD.setText(symD, TextView.BufferType.SPANNABLE);
    ...
    public void setDefaults(Class equationClass, Object o){
        ...
        try {
            if (equationClass.getDeclaredField("defaultD") != null) {
                fieldD.setText(String.valueOf(equationClass.getDeclaredField("defaultD").get(o)));
            }
        } catch (Exception e){
            Log.v("ThreeVar.setDefault", " no field found for " + equationClass.toString(), e);
        }
    ...
    public void setClassInput() throws Exception {
        ...
        //set defaults from this equation
