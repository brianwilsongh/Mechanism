...
import com.wordpress.httpspandareaktor.mekanism.PHY.PHY12;
    ...
    public void buildQuestionString(String code){
        ...
        switch (code){
            case "0111":
                ...
                break;
            case "1011":
                base = "An object exerts a force of %s newtons on a %s with a mass of %s kilograms. If they are %s meters apart, what is the mass of " +
                        "the object?";
