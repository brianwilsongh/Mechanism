...
public class PHY17 {
    ...
    public final String descriptionGeneral = "Defines impulse as mass of the object multiplied " +
            "by the change in the velocity. Part of Impulse-Momentum Theorem.";
    ...
    public Spanned symbolValC = PHYutils.PHYvarSymDeltaVelocity;
