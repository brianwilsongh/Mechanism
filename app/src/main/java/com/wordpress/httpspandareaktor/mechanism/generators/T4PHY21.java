...
import com.wordpress.httpspandareaktor.mechanism.PHY.PHY21;
...
public class T4PHY21 implements Generator {
    ...
    public T4PHY21(){
        ...
        trueAnswer = GenUtils.truncateDecimals(Double.parseDouble(PHY21.solveMissing(randomized, firstVar, secondVar)), 5);
