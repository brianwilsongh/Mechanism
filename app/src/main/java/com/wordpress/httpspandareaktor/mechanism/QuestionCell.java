...
import com.wordpress.httpspandareaktor.mechanism.generators.Generator;
...
//        setQuestion();
        tapGenerator("T4", "PHY", String.valueOf(GenUtils.generateRandomInRange(1, 28).intValue()));
    ...
    public Generator retrieveGenerator(String tier, String subject, String num) throws Exception{
        ...
        Class generatorClass = Class.forName("com.wordpress.httpspandareaktor.mechanism.generators." + tier + subject + num);
